...
MatrixPlus — это учебный проект, в рамках которого реализована собственная версия библиотеки s21_matrix_oop.h на C++ с применением объектно-ориентированного подхода. Все функции покрыты модульными тестами, написанными с помощью библиотеки GTest.
...
Ниже приведены требования к реализации проекта MatrixPlus.
