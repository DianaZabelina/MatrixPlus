...
Matrix Plus — это учебный проект, в рамках которого реализована собственная версия библиотеки s21_matrix_oop.h на C++ с применением объектно-ориентированного подхода. Все функции покрыты модульными тестами, написанными с помощью библиотеки GTest.
...
- [Информация](#информация)
    ...
    - [Напоминание основных положений о матрице](#напоминание-основных-положений-о-матрице)
    - [Операции над матрицами](#операции-над-матрицами)
- [Требования к проекту](#требования-к-проекту)

## Введение

В данном проекте реализован класс S21Matrix для работы с матрицами с использованием объектно-ориентированных принципов: инкапсуляции, конструкторов, деструкторов, перегрузки операторов.

В ходе разработки выполнено модульное тестирование с использованием библиотеки GTest и организовано формирование отчётов о покрытии кода.
...
Ниже приведены требования к реализации проекта Matrix Plus.
